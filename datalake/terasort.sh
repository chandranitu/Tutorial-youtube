...
MR_EXAMPLES_JAR=$HADOOP_HOME/share/hadoop/mapreduce/hadoop-mapreduce-examples-2.10.1.jar
...
#hadoop fs -mkdir /benchmark/teragen
INPUT=/benchmark/teragen/${SIZE}-terasort-input
OUTPUT=/benchmark/teragen/${SIZE}-terasort-output
